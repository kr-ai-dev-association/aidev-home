...
이 프로젝트는 한국인공지능개발자 협동조합의 반응형 웹 홈페이지입니다. React를 기반으로 구축되었으며, 사용자 로그인 및 회원가입, 조합 소개, 트리플 트랙(B2C·B2B·B2Academia) 사업·서비스 안내, AI 플랫폼 소개, 10x 성장 로드맵, 강사 인센티브, 최신 소식, 자주 묻는 질문 등의 기능을 제공합니다.
