...
const FAQ_GROUPS = [
  ...
  },
  {
    ...
    items: [
      {
        q: '코인은 어떻게 적립·차감되나요?',
        a: '활동에 따라 코인이 변동됩니다. 정회원 최초 승인 +1,000, 커뮤니티 글 작성 +1, 답글 작성 +0.1, 채용공고·프로젝트 구인 등록 −10, 외주 프로젝트는 첫 등록(최초 1회) 또는 이후 계약 체결(마감) 시 +100, 분쟁 조정 의뢰 −1,000. 보유 코인은 헤더의 🪙 아이콘과 내 프로필에서 확인할 수 있습니다.',
      },
      {
        q: '코인은 어떻게 충전하나요?',
        a: '코인은 1,000 coin 단위로 충전할 수 있습니다. 충전을 원하시면 관리자에게 메시지로 신청해 주세요. 결제(회비·충전) 확인 후 관리자가 코인을 적립해 드립니다.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: '노동·프리랜서·자영업 분쟁도 조정받을 수 있나요?',
        a: '네. 임금 체불·부당해고·노동 환경·산업재해·불법 파견·위장도급(다단계 비정규직)·불공정 계약·기술 탈취·지식재산권 분쟁을 프로필 메뉴의 ‘분쟁 조정 의뢰’에서 신청할 수 있습니다(의뢰 시 1,000 coin 차감). 조합이 변호사·변리사·전문가를 배정해 단계별로 조정하며, 접수부터 해결까지 각 단계가 알림과 이메일로 전달됩니다. 자세한 안내는 상단 사업·서비스 → 분쟁 조정 페이지를 참고하세요.',
      },
      {
        q: '분쟁 조정 진행 상황은 어디서 확인하나요?',
        a: '프로필 메뉴의 ‘분쟁 조정 의뢰 → 나의 조정 현황’ 탭에서 신청한 의뢰와 진행 단계(접수 → 검토 → 전문가 배정 → 조정 진행 → 해결)를 타임라인으로 확인할 수 있습니다. 단계가 갱신될 때마다 알림과 이메일로도 안내됩니다.',
      },
      {
        q: '위장도급(다단계 비정규직)이 무엇인가요?',
        a: '실제 업무는 정규직과 같은데(상시 출퇴근, 명확한 업무 지시, 매일·주간 업무 보고 등) 중간 인력 파견 업체를 끼워 비정규직·프리랜서로 계약하게 하여 임금·복지에서 차별하는 구조입니다. 이에 해당한다면 위장도급일 수 있으며, 조합이 법적 검토와 조정을 지원합니다.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: '에이전트 구축(검증된 조합원에게 프로젝트 의뢰)·에이전트 평가(Prototypebench)·에이전트 하네스·분쟁 조정(노동·계약·외주)을 제공합니다. 각 소개는 상단 사업·서비스 메뉴에서 확인할 수 있습니다. 기업·조합원은 B2B 의뢰로 견적 문의·평가 신청을 접수할 수 있으며, 관리자가 처리 상태를 관리합니다.',
      },
    ],
  },
];
